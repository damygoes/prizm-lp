	...
	return (
		<section className="grid place-items-center min-h-screen sm:p-12">
			...
			<div className="grid gap-4 p-4 max-w-5xl sm:grid-cols-4 sm:text-right sm:mt-1">
				...
				<div className="relative h-32 bg-red-500 sm:h-auto sm:aspect-auto sm:row-start-1 sm:col-start-1">
					<Image
						src={PictureTwo}
						alt="photographer holding a camera"
						layout="fill"
				...
				<div className="relative h-32 bg-orange-100 sm:h-auto sm:aspect-square sm:row-start-2">
					<Image
						src={PictureThree}
						alt="photographer holding a camera"
						layout="fill"
