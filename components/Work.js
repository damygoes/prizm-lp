...
const Work = () => {
	return (
		...
		>
			...
			<h4 className="font-bold text-2xl px-12 mt-32 z-[2] text-white sm:place-self-end sm:col-span-2 sm:px-0 sm:mr-0 sm:ml-12 md:col-start-1 md:row-start-1 md:col-span-4 md:place-self-start md:text-3xl md:mx-auto md:pr-48 md:ml-0 lg:text-3xl lg:px-0 lg:col-start-1 lg:col-span-3">
				Floral Design -
			...
			<div className="relative h-64 bg-blue-50 rounded-xl w-3/4 mt-24 z-[2] sm:w-full sm:mt-12 sm:col-start-1 sm:row-start-3 sm:col-span-2 sm:place-self-start sm:aspect-square md:col-start-4 md:row-start-1 md:w-full md:place-self-end lg:place-self-end xl:place-self-end">
				{/* red */}
				<Image
					src={FlowerOne}
					alt="flower"
			...
			<div className="relative h-64 w-3/4 bg-blue-50 rounded-xl z-[2]  sm:w-full sm:col-start-2 sm:row-start-4 sm:place-self-start sm:mt-[-5rem] sm:aspect-square md:col-start-1 md:row-start-2 md:col-span-3 md:w-full md:place-self-start md:mt-24 lg:mt-52 lg:col-start-1 lg:col-span-7 xl:h-96 xl:aspect-square xl:place-self-center">
				<Image
					...
					layout="fill"
					// objectFit="cover "
					className="object-contain sm:object-cover sm:object-top md:object-left lg:object-left xl:object-contain"
				/>
			</div>
		</section>
	);
